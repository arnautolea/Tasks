...
[Hint: ItТs possible to do this exercise with the techniques you 
learned in this chapter. YouТll need to use both division and 
remainder operations to Уpick offФ each digit.]*/
package Chapter02;
...
//или 012345 считаетс€ верным и не учитываетс€ перва€ цифра..
